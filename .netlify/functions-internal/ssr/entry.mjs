...
import { manifest } from './manifest_BrZjUeUr.mjs';
...
const _page6 = () => import('./pages/glossary.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/formations.astro", _page5],
    ["src/pages/glossary.astro", _page6],
