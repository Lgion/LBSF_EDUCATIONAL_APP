        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="mb-8">
            <img
              ...
              src="/images/II_introduction/3_ingenierie/3units.webp"
